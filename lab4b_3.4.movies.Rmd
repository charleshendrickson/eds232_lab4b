...
**When I used 3 hidden layers, the training loss decreases with every epoch, and the training accuracy increases with every epoch, just like with 2 hidden layers. However, the validation loss and accuracy seem to peak much quicker around the 3rd epoch. Thus, overfitting seems to increase after adding an additional hidden layer.**

**Additionally, when I used 3 hidden layers, it resulted in an increase in the loss and a decrease in the test accuracy (loss = 0.3767887, accuracy = 0.8579600).**

* Try to use layers with more hidden units or less hidden units: 32 units, 64 units...

**When I used 32 hidden units, the training loss decreases with every epoch, and the training accuracy increases with every epoch, just like the original. However, the validation loss and accuracy seem to peak much quicker around the 5th epoch. Thus, overfitting seems to increase after adding an additional hidden units.**

**When I increased the hidden units from 16 to 32, it resulted in an increase in the loss and a decrease in the test accuracy (loss = 0.3275188, accuracy = 0.8746400).** 

* Try to use the `mse` loss function instead of `binary_crossentropy`.

**The `mse` loss function made huge changes to the loss. It resulted in an decrease in the loss and no change in the test accuracy (loss = 0.08890396, accuracy = 0.88116002).**

**The `mse` loss function made the training loss decreases with every epoch, and the training accuracy increases with every epoch, just like the original. However, the validation loss and accuracy remained relatively constant and did not peak with increasing epochs.**

* Try to use the `tanh` activation (an activation that was popular in the early days of neural networks) instead of `relu`.

**The `mse` loss function smaller changes to the loss and accuracy. It resulted in an increase in the loss and a slight decrease in the test accuracy (loss = 0.3339678, accuracy = 0.8746400).**

**The `tanh` activation made the training loss decreases with every epoch, and the training accuracy increases with every epoch, just like the original. However, the validation loss increased linearly with additional epochs, while accuracy remained relatively constant and peaked a 5 epochs.**
