...
**By using 128 units, our approach increased slightly to an accuracy of ~79%. With a balanced binary classification problem, the accuracy reached was about 20%. (the was increased loss = 1.0500493, and little change in accuracy = 0.7876225)**

* We were using two hidden layers. Now try to use a single hidden layer, or three hidden layers.

**By only using one hidden layer, the accuracy and the val_accuracy are much more similar in value than before when we compress the information into the 4 dimensional intermediate layers.**
